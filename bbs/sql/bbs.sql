...
CREATE TABLE `bbs_appeal_receipt`  (
  ...
  `appeal_official_reply` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '官方回复',
  `appeal_user_reply` varchar(800) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  DEFAULT NULL COMMENT '用户回复',
  `deleted` tinyint(4) NULL DEFAULT 0 COMMENT '逻辑删除标记位',
  `version` bigint(20) NULL DEFAULT 0 COMMENT '乐观锁',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
