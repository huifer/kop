...
public class CustomerTopicController {
  ...
  @Resource private TopicCommentService topicCommentService;

  @ApiOperation("创建话题")
  @PostMapping("/create")
  public RespVO<Boolean> create(@RequestBody TopicCreateReq req) {
  ...
  @ApiOperation("评论话题")
  @PostMapping("/comment")
  public RespVO<Boolean> comment(@RequestBody TopicCommentReq req) {
