...
import com.github.kop.bbs.service.invitation.impl.InvitationCommentServiceImpl;
...
public class TopicCommentServiceImpl implements TopicCommentService{
    ...
    public Boolean create(TopicCommentReq req) {
        ...
        return topicCommentRepository.insert(TopicComment.builder()
    ...
    protected class TopicCreateAndUpdateValidate
            implements CreateValidate<TopicCommentReq> {

        @Override
        public void createValidate(TopicCommentReq req)
