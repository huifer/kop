...
public class UserCategoryVoteSettingImpl implements UserCategoryVoteSettingRepository {
    ...
    @Resource
    private UserCategoryVoteSettingMapper midUserCategoryVoteMapper;
    ...
    @Override
    public IPage<UserCategoryVoteSetting> voteSettingList(Long categoryId,Integer orderType, Integer page, Integer pageSize) {
        QueryWrapper<UserCategoryVoteSetting> queryWrapper = new QueryWrapper<>();
        LambdaQueryWrapper<UserCategoryVoteSetting> eq = queryWrapper.lambda()
