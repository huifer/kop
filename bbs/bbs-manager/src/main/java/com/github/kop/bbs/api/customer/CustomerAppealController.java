...
public class CustomerAppealController {
  ...
  @Resource private AppealReceiptService appealReceiptService;

  @ApiOperation(value = "发起申诉")
  @PostMapping("/")
  public RespVO<Boolean> create(@RequestBody CreateAppealReq req) {
  ...
  public RespVO<List<AppealReceiptResp>> receiptList(@PathVariable Long appealId) {
