...
public class UserCategoryVoteSettingServiceImpl implements UserCategoryVoteSettingService {
    ...
    private VoteSettingAndUpdateValidate voteSettingAndUpdateValidate = new VoteSettingAndUpdateValidate();
    ...
    @Override
    public IPage<VoteSettingListRes> voteSettingList(voteSettingListReq req, Integer page, Integer pageSize) {
        if(ObjectUtils.isEmpty(req.getOrderType())){
            req.setOrderType(voteSettingListReq.voteSettingListOrderType.APPLY_TIME.getCode());
        }
        IPage<UserCategoryVoteSetting> pageData =  userCategoryVoteSettingRepository.voteSettingList(req.getCategoryId(),req.getOrderType(),page,pageSize);
    ...
    private VoteSettingListRes entity2voteSettingListRes(UserCategoryVoteSetting item){
        ...
        voteSettingListRes.setApplicationCount(item.getApplicationCount() == 0 ? "不限制":item.getApplicationCount()+"人" );
    ...
    private CustomerUserCategoryVoteSettingRes entity2CustomerUserCategoryVoteSettingRes(UserCategoryVoteSetting userCategoryVoteSetting){
        ...
        res.setApplicationCount(userCategoryVoteSetting.getApplicationCount() == 0 ? "不限制" : userCategoryVoteSetting.getApplicationCount() + "人");
    ...
    public Boolean create(UserCategoryVoteSettingReq req) {
        ...
        return userCategoryVoteSettingRepository.insert(UserCategoryVoteSetting.builder()
